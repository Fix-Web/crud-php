...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-05-2020 a las 05:28:18
...
INSERT INTO `nombre` (`idnombre`, `nombre`, `edad`) VALUES
(1, 'Nombre1', 12),
(6, 'Nombre3', 18);
...
--
ALTER TABLE `nombre`
  MODIFY `idnombre` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
COMMIT;
